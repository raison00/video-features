                ...
                _initPanels: function () {
                    ...
                    t.each(function () {
                        ...
                        if (n.data(d.parent, i), i.parent().is("." + l.list)) {
                           ...
                           // alert("hi");
                            if($("#appConfigName").html() == "mcom") {
                            	a.is("a") || r.addClass(l.fullsubopen), s.opts.slidingSubmenus && t.prepend('<li id="top"><a href="#mb-j-nav-menu" class="mm-subclose nav_mm-subclose">Menu</a></li> <li class="' + l.subtitle + '"><a class="' + l.subclose + '" href="#' + o.attr("id") + '">' + a.text() + "</a></li>")
                            }
                            else if($("#appConfigName").html() == "bcom") {
                            	a.is("a") || r.addClass(l.fullsubopen), s.opts.slidingSubmenus && t.prepend('<li id="top"><a href="#bc_mb-j-nav-menu" class="mm-subclose nav_mm-subclose">Menu</a></li> <li class="' + l.subtitle + '"><a class="' + l.subclose + '" href="#' + o.attr("id") + '">' + a.text() + "</a></li>")	
                            }
                        }
                    });
